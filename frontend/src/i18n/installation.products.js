const chlorineProjects = [
    {
        ...
        scope: {
            en: 'Supply and installation of chlorine gas system',
            ar: 'توريد وتركيب منظومة كلور غاز'
        },
        capacity: '20 kg/h',
        client: 'IETOS',
        year: 2025,
    ...
    },
    {
        ...
        title: {
            en: 'Tanawf Wastewater Plant',
            ar: 'محطة الصرف الصحي بتأنوف'
        },
        titleHighlight: {
            en: 'Wastewater Plant',
            ar: 'الصرف الصحي'
    ...
    },
    {
        ...
        title: {
            en: 'Abu Aziz Water Plant',
            ar: 'محطة مياه أبو عزيز'
        },
        titleHighlight: {
            en: 'Water Plant',
            ar: 'محطة مياه'
    ...
    },
    {
        ...
        scope: {
            en: 'Supply and installation of chlorine neutralization system',
            ar: 'توريد وتركيب منظومة تحييد غاز الكلور'
        },
        capacity: '5000 m³/h',
        client: 'IWOMT',
        year: 2025,
    ...
    },
    {
        ...
        scope: {
            en: 'Supply and installation of chlorine injection system',
            ar: 'توريد وتركيب منظومة حقن كلور'
        },
        client: 'IWOMT',
        year: 2025,
        location: {
            en: 'New Alamein, Egypt',
            ar: 'العلمين الجديدة – مصر'
        }
    },
    {
        id: 7,
        ...
        scope: {
            en: 'Chlorine system rehabilitation',
            ar: 'إعادة تأهيل منظومة الكلور'
        },
        workExecuted: {
            en: 'Booster Pumps & Caustic Soda System',
            ar: 'طلمبات Booster & منظومة Caustic Soda'
        },
        client: 'IETOS',
        year: 2025,
        location: {
    ...
    },
    {
        ...
        scope: {
            en: 'Supply and installation of liquid chlorine system',
            ar: 'توريد وتركيب منظومة كلور سائل'
        },
        capacity: '200 kg/h',
        client: 'Hightech',
        year: 2025,
    ...
    },
    {
        ...
        scope: {
            en: 'Liquid chlorine system (standby operation)',
            ar: 'منظومة كلور سائل (تعمل في حالة الليكويد)'
        },
        capacity: '120 kg/h',
        client: 'CHP',
        year: 2025,
    ...
    },
    {
        ...
        scope: {
            en: 'Assembly and testing of 30 chlorine systems with various capacities',
            ar: 'تجميع واختبار 30 منظومة كلور بقدرات مختلفة'
        },
        capacity: '2.4 – 10 kg/bar/h',
        client: 'IETOS',
        year: 2025,
        location: {
            en: 'Minya, Egypt',
    ...
    },
    {
        ...
        scope: {
            en: 'Supply, installation, testing, and commissioning of chlorine system',
            ar: 'توريد وتركيب واختبار وتشغيل منظومة كلور'
        },
        capacity: '15 kg/h',
        client: 'IETOS',
        year: 2025,
...
export default chlorineProjects;
